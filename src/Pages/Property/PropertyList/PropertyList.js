      ...
      <div style={twnButtonStyles.allPagesWithoutPadding}>
        {width <= 768 ? (
          ...
          <div>
            ...
            />
            <Card style={{ boxShadow: 'none', border: '1px solid #F4F4F4', padding:'0 1%'}}>
                      ...
                      .map((row) => {
                        ...
                        return (
                          <TableRow hover key={id} tabIndex={-1}>
                            ...
                            <TableCell align="left" style={{fontSize:'12px'}}>{starRating}</TableCell>
                            <TableCell align="left" style={{fontSize:'12px'}}>{noofRooms}</TableCell>
