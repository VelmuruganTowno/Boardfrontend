    ...
    return (
        ...
        >
            <Box style={mystyle}>
                ...
                <TabPanel value={value} handleClose={props.handleClose} selectedTable={props.selectedTable} clickedRowId={props.clickedRowData.id} fetchBoard={props.fetchBoard} />
            </Box>
        </Modal>
    );
}
...
const submitLeadModal = (selectedTable, id, leadscoring, leadscoringvalue, reason, handleClose, fetchBoard) => {
    ...
    Api.put(url, data)
        .then((response) => {
            console.log("UPDATE RECORD: ", response); // 6
            handleClose();
            fetchBoard();
        })
                    ...
                    >
                        <Stack direction='row' spacing={2} justifyContent="space-around">
                            <IconButton color="error" >
                                <FormControlLabel value="followuphot" control={<Radio style={{ color: 'rgb(244, 109, 37)' }} />} />
                                <WhatshotTwoToneIcon />
                                &nbsp;Hot
                            </IconButton>
                            <IconButton color="warning">
                                <FormControlLabel value="followupwarm" control={<Radio style={{ color: 'rgb(244, 109, 37)' }} />} />
                                <BrightnessHighIcon />
                                &nbsp; Warm
                            </IconButton>
                            <IconButton color="primary" >
                                <FormControlLabel value="followupcold" control={<Radio style={{ color: 'rgb(244, 109, 37)' }} />} />
                                <AcUnitIcon />
                                &nbsp; Cold
                            </IconButton>
                        </Stack>
