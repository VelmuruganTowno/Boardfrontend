...
export default function ClientRefresh(props) {
  ...
  function createClient(fields) {
    ...
    onClose(true);
    window.open(`/createPackageOrQuotation/${props.pkgOrQtn}/${props.displayLeads}`,"_self")
  }
  ...
  const validCheck = async (values) => {
    ...
    if (!values) {
      ...
      Api.post("clientcheckmail/" + uniqueid, valid).then((res) => {
        // eslint-disable-next-line eqeqeq
        if (res.data == "Invalid") {
          errors.mail = "Emailis Already Exist";
        } else {
          errors.mobile = "";
  ...
  const validCheckMobile = async (values) => {
    ...
    if (!values) {
      ...
      Api.post("clientcheck/" + uniqueid, valid).then((res) => {
        // eslint-disable-next-line eqeqeq
        if (res.data == "Invalid") {
          errors.mobile = "Mobile No is Already Exist";
        } else {
          errors.mobile = "";
  ...
  return (
    <>
      ...
      >
        ...
        <h2 style={{ color: "#F46D25", margin: "0px" }}>Add Client</h2>
        <Formik
              ...
              <Form autoComplete="off">
                ...
                >
                  ...
                  <Button
                    ...
                    // onClick={()=>{window.open(`/createPackage/${props.isPackage}/${props.displayLeads}/${props.id}`,"_self")}}
                  >
                    Submit
                  </Button>
                  <Button
