...
export default function RoomListView() {
  ...
  const DisplayNameGet = async () => {
    await axios.get(baseurl + "getdisplayname/" + hotelName).then((res) => {
  ...
  const updateRent = (e) => {
    ...
    axios.post(baseurl + "calenderviewupdate", RoomRentUpdate).then((res) => {
      if (res.data) {
        RoomFetch();
      }
    });
  ...
  const updateSold = (e) => {
    ...
    axios
      .post(baseurl + "calenderviewsoldupdate", RoomRentUpdate)
      .then((res) => {
        if (res.data) {
          RoomFetch();
        }
  ...
  const updateRentCp = (e) => {
    ...
    axios
      .post(baseurl + "calenderviewCpRateupdate", RoomRentUpdate)
      .then((res) => {
        if (res.data) {
          RoomFetch();
        }
  ...
  const updateRentMap = (e) => {
    ...
    axios
      .post(baseurl + "calenderviewMapRateupdate", RoomRentUpdate)
      .then((res) => {
        if (res.data) {
          RoomFetch();
        }
  ...
  const updateRentAp = (e) => {
    ...
    axios
      .post(baseurl + "calenderviewApRateupdate", RoomRentUpdate)
      .then((res) => {
        if (res.data) {
          RoomFetch();
        }
  ...
  const hotelFetch = () => {
    axios.get(baseurl + "propertybasicpropertydetailsall").then((res) => {
  ...
  const RoomFetch = async () => {
    ...
    await axios
      .get(
        `${baseurl}calenderviewall/${hotelName}/${apiStartDate}/${apiEndDate}`
      )
      .then((res) => {
