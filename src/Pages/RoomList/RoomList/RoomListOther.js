...
export default function RoomListOther() {
  ...
  const RoomFetch = async () => {
    ...
    } else if ((hasAdmin == "Agent Admin" || hasAgent == "Agent") && ( AgentType == "gold" || typeAgent == "gold")) {
      urlget = `calenderviewgold/${hotelName}/${apiStartDate}/${apiEndDate}`;
    } else if ((hasAdmin == "Agent Admin" || hasAgent == "Agent") && (AgentType == "silver" || typeAgent == "silver")) {
      urlget = `calenderviewsilver/${hotelName}/${apiStartDate}/${apiEndDate}`;
    } else if ((hasAdmin == "Agent Admin" || hasAgent == "Agent") && (AgentType == "bronze" || typeAgent == "bronze")) {
