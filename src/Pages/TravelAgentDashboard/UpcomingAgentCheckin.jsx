...
export default function UpcomingAgentCheckin() {
  ...
  const UpcomingCheckin = () => {
    ...
    //     break;
    // }
    var url = `TravelAgentDashboardUpcomingBookingNew/${uniqueId}/${daysChange}`
        if (notAdmin) { url = `TravelAgentStaffDashboardUpcomingBookingNew/${uniqueId}/${daysChange}/${Auth}` }
                        ...
                        .map((row, index) => {
                          return (
                            <TableRow key={row.id}>
                              ...
                              <TableCell>{row.noOfAdult}</TableCell>
                              <TableCell>{row.noOfChild}</TableCell>
                              <TableCell>{row.totalRoomCount}</TableCell>
                            </TableRow>
                          );
                        })}
                    </TableBody>
