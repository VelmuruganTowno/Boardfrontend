...
export default function AgentClientVoucher() {
              ...
              <tr>
                <td style={{ width: "50%" }}>
                  ...
                  <b style={{ color: "#fff", padding: "2px 0px" }}>
                    {bookingDetails.rooms} Rooms | {bookingDetails.night}
                    Nights
                  </b>
                </td>
                <td
        ...
        >
          ...
          <table style={{ width: "100%", padding: "10px" }}>
            <tbody>
              ...
              <tr>
                <td style={{ width: "49%" }}>Payment Mode</td>
                <td style={{ width: "2%" }}>:</td>
                <td style={{ width: "49%", textTransform: "uppercase" }}>
                  {/* {roomPayment.map((item) => (
                    <span key={item.id}> */}
                       {bookingDetails.agentBookingPayments?bookingDetails.agentBookingPayments[0].paymentMode:""}
                      {/* </span>
                  ))} */}
                </td>
              </tr>
              <tr>
                ...
                <td style={{ width: "49%" }}>
                  {/* {roomPayment.map((item) => (
                    <span key={item.id}> */}
                      {bookingDetails.agentBookingPayments?bookingDetails.agentBookingPayments[0].paymentRefNo:""}
                      {/* </span>
                  ))} */}
                </td>
              </tr>
              <tr>
                ...
                <td style={{ width: "49%" }}>
                  ...
                  {/* ))} */}
                  {format(moment(bookingDetails.createdAt).toDate(),"dd-MM-yyyy")}
                </td>
              </tr>
            </tbody>
            <tfoot>
